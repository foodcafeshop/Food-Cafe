...
export default function D2CHero({ searchValue, onSearchChange }: D2CHeroProps) {
    return (
        <section className="relative min-h-[85vh] flex flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-orange-50 via-white to-amber-50">
            ...
            <div className="relative z-10 container mx-auto px-4 text-center pt-24 pb-8">
                {/* Badge */}
                <motion.div
                ...
                <motion.h1
                    ...
                    className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tight text-zinc-900 mb-6 leading-tight"
                >
                    Scan. Order.
                    <br />
