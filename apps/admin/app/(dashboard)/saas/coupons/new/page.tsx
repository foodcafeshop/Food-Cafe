...
export default function NewCouponPage() {
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-8">
            <div>
                <h2 className="text-3xl font-bold tracking-tight text-white">New Platform Coupon</h2>
                <p className="text-slate-400">Create a discount for subscription plans.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 bg-slate-900 p-8 rounded-lg border border-slate-800">
                <div className="grid gap-4">
                    <div>
                        ...
                        <input name="code" required className="w-full bg-slate-950 border border-slate-700 rounded p-2 text-white uppercase" placeholder="WELCOME50" />
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-medium text-slate-300 mb-2">Discount Type</label>
                            <select name="discount_type" className="w-full bg-slate-950 border border-slate-700 rounded p-2 text-white">
                        ...
                        <div>
                            ...
                            <input name="discount_amount" type="number" step="0.01" required className="w-full bg-slate-950 border border-slate-700 rounded p-2 text-white" placeholder="50" />
                        </div>
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-medium text-slate-300 mb-2">Max Uses</label>
                            <input name="max_uses" type="number" className="w-full bg-slate-950 border border-slate-700 rounded p-2 text-white" placeholder="Total global uses" />
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <input name="gateway_coupon_id" className="w-full bg-slate-950 border border-slate-700 rounded p-2 text-white" placeholder="offer_..." />
